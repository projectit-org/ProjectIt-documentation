import{S as xs,i as ws,s as Ls,e as l,t as a,k as c,w as Va,c as i,a as r,h as s,d as n,m as u,x as Xa,b as d,g as p,H as t,y as Za,q as es,o as ns,B as ts}from"../../../chunks/vendor-492729b6.js";import{N as as}from"../../../chunks/Note-1bdf01a3.js";/* empty css                                                         */function As(S){let f;return{c(){f=a("Models are never explicit in an editor")},l(m){f=s(m,"Models are never explicit in an editor")},m(m,y){p(m,f,y)},d(m){m&&n(f)}}}function Ds(S){let f;return{c(){f=a(`The model is never shown in an editor as a whole. 
