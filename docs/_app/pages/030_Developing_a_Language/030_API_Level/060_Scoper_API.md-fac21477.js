import{S as le,i as re,s as ie,e as r,t,k as y,c as i,a as c,g as o,d as n,n as b,b as ne,f as p,F as a,H as K}from"../../../chunks/vendor-0216fdcb.js";function ce(ae){let u,R,x,m,Y,v,z,W,P,d,se=`<code class="language-ts"><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">PiScoper</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`,N,g,j,T,l,D,E,H,F,w,V,A,S,M,q,I,h,G,_,B,J,L,f,te=`<code class="language-ts"><span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">EntityEnvironment</span> <span class="token keyword">implements</span> <span class="token class-name">PiEnvironment</span> <span class="token punctuation">&#123;</span>
    <span class="token operator">...</span>
...
The new scoper needs to implement the following interface.`),P=y(),d=r("pre"),N=y(),g=r("h2"),j=t("Adjusting the Environment"),T=y(),l=r("p"),D=t(`Furthermore, you need to tell ProjectIt to use this new scoper instead of the generate one. You do this by
changing the line that initializes the scoper in the class `),E=r("code"),H=t("<yourLanguageName>Environment"),F=t(`. You can find it
in `),w=r("code"),V=t("~/picode/environment/"),A=t(`. Obviously,
you need to exchange `),S=r("code"),M=t("<yourLanguageName>"),q=t(" by the name of the language that you are creating."),I=y(),h=r("p"),G=t("Suppose the class "),_=r("code"),B=t("YourScoper"),J=t(`
...
scoper by one create yourself.
The new scoper needs to implement the following interface.`),C.forEach(n),P=b(e),d=i(e,"PRE",{class:!0});var oe=c(d);oe.forEach(n),N=b(e),g=i(e,"H2",{});var U=c(g);j=o(U,"Adjusting the Environment"),U.forEach(n),T=b(e),l=i(e,"P",{});var k=c(l);D=o(k,`Furthermore, you need to tell ProjectIt to use this new scoper instead of the generate one. You do this by
changing the line that initializes the scoper in the class `),E=i(k,"CODE",{});var X=c(E);H=o(X,"<yourLanguageName>Environment"),X.forEach(n),F=o(k,`. You can find it
in `),w=i(k,"CODE",{});var Z=c(w);V=o(Z,"~/picode/environment/"),Z.forEach(n),A=o(k,`. Obviously,
you need to exchange `),S=i(k,"CODE",{});var $=c(S);M=o($,"<yourLanguageName>"),$.forEach(n),q=o(k," by the name of the language that you are creating."),k.forEach(n),I=b(e),h=i(e,"P",{});var O=c(h);G=o(O,"Suppose the class "),_=i(O,"CODE",{});var ee=c(_);B=o(ee,"YourScoper"),ee.forEach(n),J=o(O,`
holds the scoper with the improvements that you have made, then the entry in the environment class would be:`),O.forEach(n),L=b(e),f=i(e,"PRE",{class:!0});var pe=c(f);pe.forEach(n),this.h()},h(){ne(d,"class","language-ts"),ne(f,"class","language-ts")},m(e,s){p(e,u,s),a(u,R),p(e,x,s),p(e,m,s),a(m,Y),a(m,v),a(v,z),a(m,W),p(e,P,s),p(e,d,s),d.innerHTML=se,p(e,N,s),p(e,g,s),a(g,j),p(e,T,s),p(e,l,s),a(l,D),a(l,E),a(E,H),a(l,F),a(l,w),a(w,V),a(l,A),a(l,S),a(S,M),a(l,q),p(e,I,s),p(e,h,s),a(h,G),a(h,_),a(_,B),a(h,J),p(e,L,s),p(e,f,s),f.innerHTML=te},p:K,i:K,o:K,d(e){e&&n(u),e&&n(x),e&&n(m),e&&n(P),e&&n(d),e&&n(N),e&&n(g),e&&n(T),e&&n(l),e&&n(I),e&&n(h),e&&n(L),e&&n(f)}}}class me extends le{constructor(u){super();re(this,u,null,ce,ie,{})}}export{me as default};
