...
/**
 * Class GreaterThenExpression is the implementation of the binary expression concept with the same name in the language definition file.
...
export class GreaterThenExpression extends ComparisonExpression implements PiBinaryExpression {
    ...
    readonly $typename: EntityMetaType = "GreaterThenExpression"; // holds the metatype in the form of a string
