...
/**
 * Class DivideExpression is the implementation of the binary expression concept with the same name in the language definition file.
...
export class DivideExpression extends BinaryExpression implements PiBinaryExpression {
    ...
    readonly $typename: EntityMetaType = "DivideExpression"; // holds the metatype in the form of a string
