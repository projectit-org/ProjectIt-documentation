...
import { EntityExpression, EntityFunction, EntityMetaType, PiElementReference } from "./internal";
 ...
 */
@model
export class FunctionCallExpression extends EntityExpression implements PiExpression {
    /**
    ...
    functionDefinition: PiElementReference<EntityFunction>; // implementation of reference 'functionDefinition'
