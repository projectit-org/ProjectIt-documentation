...
/**
 * Class EqualsExpression is the implementation of the binary expression concept with the same name in the language definition file.
...
export class EqualsExpression extends ComparisonExpression implements PiBinaryExpression {
    ...
    readonly $typename: EntityMetaType = "EqualsExpression"; // holds the metatype in the form of a string
