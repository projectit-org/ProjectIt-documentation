 ...
 */
@model
export class IfExpression extends EntityExpression implements PiExpression {
    /**
    ...
    readonly $typename: EntityMetaType = "IfExpression"; // holds the metatype in the form of a string
